...
const collectedItems = [
  ...
  {
    category: "서비스 이용 분석",
    items: "페이지 방문, 클릭 이벤트, 접속 경로, 브라우저 및 기기 정보, 익명 방문자 식별자",
    purpose: "서비스 이용 현황 분석, 화면 구성과 콘텐츠 개선, 공개 페이지 품질 개선",
    retention: "분석 목적 달성 시까지 또는 분석 서비스 보관 기간 만료 시까지",
  },
  {
  ...
  return (
    <article className="mx-auto w-full max-w-4xl space-y-10 py-12">
      ...
      <PolicySection title="5. 개인정보의 국외 이전">
        <p>
          오류 모니터링 서비스가 활성화된 경우 Sentry로 오류 진단 정보가, 이용 분석 서비스가 활성화된
          경우 PostHog로 익명 이용 분석 정보가 국외 이전될 수 있습니다. 이전되는 정보는 장애 대응,
          서비스 이용 현황 분석, 품질 개선에 필요한 기술 정보로 제한됩니다.
        </p>
      </PolicySection>
      ...
      <PolicySection title="9. 개인정보 자동 수집 장치">
        <p>
          ...
          통해 쿠키를 차단할 수 있으나 이 경우 로그인이 필요한 기능 이용이 제한될 수 있습니다. 공개
          페이지의 이용 현황 분석을 위해 익명 방문자 식별자와 클릭 이벤트를 수집할 수 있으며, 브라우저의
          추적 거부 설정이 활성화된 경우 이를 존중합니다.
        </p>
      </PolicySection>
