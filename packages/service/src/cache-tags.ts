export const CLUB_REVALIDATE_SECONDS = 120;
export const CLUB_SCHEDULE_REVALIDATE_SECONDS = 180;
export const CLUB_REPORT_REVALIDATE_SECONDS = 120;
export const MAIN_BANNER_REVALIDATE_SECONDS = 180;
