...
| admin user management | [filterable-user-list.test.ts](../../apps/DONGLE-ADMIN/src/feature/user/components/filterable-user-list.test.ts), [delete-user.action.test.ts](../../apps/DONGLE-ADMIN/src/feature/user/action/delete-user.action.test.ts) | code-graded | 검색 필터 로직 / 사용자 목록 조회 실패 안내 / 자기 계정 삭제 방지 |
...
| client search | [use-club-filters.test.ts](../../apps/DONGLE-CLIENT/src/hooks/use-club-filters.test.ts), [club-list-section.test.tsx](../../apps/DONGLE-CLIENT/src/components/main/club-list-section.test.tsx) | code-graded | filtering / recruiting count helper / summary / query string parser-builder / 메인 동아리 목록 조회 실패 안내 |
