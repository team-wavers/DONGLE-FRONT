...
| admin schedule management | [schedule.utils.test.ts](../../apps/DONGLE-ADMIN/src/feature/schedule/schedule.utils.test.ts) | code-graded | 캘린더 날짜 계산 / 일정 필터 / 시작일시 정렬 / 백엔드 응답 매핑 |
...
| shared normalization | [string.test.ts](../../packages/utils/src/string.test.ts), [phone.test.ts](../../packages/utils/src/phone.test.ts), [date.test.ts](../../packages/utils/src/date.test.ts) | code-graded | trim/nullable/phone/date normalization and display/request formatting helper |
...
| client club schedule | [club-schedule.test.ts](../../apps/DONGLE-CLIENT/src/lib/club-schedule.test.ts) | code-graded | 동아리 상세 공개 일정 필터 / 다가오는 일정과 지난 일정 분리 / 시작일시 정렬 / 백엔드 응답 매핑 |
