...
export default function SentryExamplePageClient() {
    const handleCaptureException = () => {
        Sentry.captureException(new Error("dongle-admin sentry example page test error"));
    };

    const handleUnhandledError = () => {
        throw new Error("dongle-admin sentry example page unhandled error");
    };
        ...
        <div className="mx-auto flex min-h-[60vh] max-w-xl flex-col justify-center gap-6 py-16">
            <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                    버튼을 눌러 `dongle-admin` 프로젝트에 테스트 에러를 전송할 수 있습니다.
                </p>
            </div>
